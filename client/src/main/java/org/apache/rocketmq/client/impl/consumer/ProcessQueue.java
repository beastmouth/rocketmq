 ...
 * PullMessageService从消息服务器默认每次拉取32条消息，按照消息队列偏移量的顺序存放在ProcessQueue中，
...
public class ProcessQueue {
    ...
    public boolean isPullExpired() {
        // 判断PullMessageService是否空闲，空闲时间默认120s
    ...
    /**
     * 获取当前消息的最大间隔。getMaxSpan并不能说明ProcessQueue包含的消息个数
     * 但是能说明当前处理队列中第一条消息与最后一条消息的便宜来那个已经超过的消息个数
     * @return
     */
    ...
    /**
     * 将consumingMsgOrderlyTreeMap中的所有消息重新放入msgTreeMap
     */
