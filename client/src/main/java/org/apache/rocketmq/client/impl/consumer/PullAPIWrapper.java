...
public class PullAPIWrapper {
    ...
    public PullResult pullKernelImpl(
        final MessageQueue mq, /*从哪条消息消费队列拉取消息*/
        ...
        final long brokerSuspendMaxTimeMillis, /*消息拉取过程中允许Broker挂起的时间 默认15s*/
        ...
        // 根据BrokerName,BrokerId获取Broker地址信息
        // 主从结构的Broker，BrokerName相同，id不同 => id用于集群模式拉取，从节点拉取
        ...
        if (findBrokerResult != null) {
            ...
            if (PullSysFlag.hasClassFilterFlag(sysFlagInner)) {
                // 如果消息过滤模式为类过滤，则会根据topic和broker地址找到注册在Broker上的FilterServer地址
                // 从FilterServer拉取消息，否则就是从Broker拉取消息
